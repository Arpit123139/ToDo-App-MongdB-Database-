...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.MyViewHolder> {
   ...
   final private RecyclerViewClickListener clickListener;
    public TodoListAdapter(Context context, ArrayList<TodoModel> arrayList,RecyclerViewClickListener recyclerViewClickListener) {          // The third Parameter means that the methods of the Listener are implemented in the HomeActivity
