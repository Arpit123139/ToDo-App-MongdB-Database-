...
public class FinishedTaskAdapter extends RecyclerView.Adapter<FinishedTaskAdapter.MyViewHolder> {
    ...
    public FinishedTaskAdapter(Context context, ArrayList<TodoModel> arrayList,RecyclerViewClickListener recyclerViewClickListener) {          // The third Parameter means that the methods of the Listener are implemented in the HomeActivity
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.finished_task_item, parent, false);

        final MyViewHolder myViewHolder = new MyViewHolder(view);

        /****************************************ADDING THE RANDOM COLORS**************************************************/
        ...
        // On Clicking the releative Layout will become VISIBLE
